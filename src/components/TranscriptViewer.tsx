        ...
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex flex-col">
                {transcript ? (
                    <>
                        {isEditing ? (
                            <Textarea
                                ...
                                className="flex-1 min-h-[200px] max-h-[400px] w-full resize-none text-slate-700 leading-relaxed overflow-y-auto"
                            ...
                            <div
                                ref={scrollRef}
                                className="flex-1 min-h-[200px] max-h-[400px] w-full overflow-y-auto p-4 bg-slate-50 rounded-lg border"
                            >
                    ...
                    <div className="h-[350px] flex flex-col items-center justify-center text-slate-400 bg-slate-50 rounded-lg border">
            ...
            {/* Stats */}
            {transcript && (
                <div className="mt-4 flex justify-between items-center text-sm text-slate-500 bg-slate-100 rounded-lg">
