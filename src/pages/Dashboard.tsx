            ...
            <div className="container mx-auto px-6 py-8">
                <div className="max-w-6xl mx-auto">
                    {!showSchedule ? (
                        <>
                            <div className="mb-8">
                                <h1 className="text-4xl font-bold mb-4 text-gradient">Dashboard Transcript</h1>
                                ...
                                <Card className="p-6 glassmorphism border-0 shadow-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold">
                                                {transcripts
                                                    .reduce((acc, t) => acc + t.transcript.split(" ").length, 0)
                                                    .toLocaleString()}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <Card className="p-6">
                                ...
                                {transcripts.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <Link to="/transcribe">
                                            <Button className="gradient-primary text-white">Mulai Transcribe</Button>
                                        </Link>
                                    </div>
                                ) : (
                                ...
                                {schedules.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {schedules.map(schedule => (
                                            <Card
                                                key={schedule.id}
                                                className="p-4 hover-lift flex justify-between items-center"
                                            >
                                                <div>
